...
--
-- Host: localhost
-- Generation Time: Dec 14, 2016 at 01:14 PM
...
INSERT INTO `akun` (`id`, `nama`, `kode`, `kelompok_akun_id`, `pajak`, `simpanan`, `saldo_awal`, `saldo`, `keterangan`) VALUES
(1, 'Simpanan Wajib', '202', 4, 0, 1, 0, -75000, ''),
(2, 'Kas', '101', 1, 0, 0, 0, 75000, '');
...
INSERT INTO `anggota` (`id`, `no_anggota`, `nama`, `tgl_masuk`, `alamat`, `kota`, `telpon_1`, `telpon_2`, `pekerjaan`, `jns_id`, `no_id`, `email`, `website`, `keterangan`) VALUES
(1, '1', 'Non-Anggota', '2016-12-14', 'n/a', 'n/a', 'n/a', '', '', '', '', '', '', ''),
(2, '2', 'Rudi Antara', '2016-12-14', 'Surabaya', 'Surabaya', '08560606435', '', '', '', '', '', '', '');
...
INSERT INTO `jurnal` (`id`, `no`, `tgl`, `f_id`, `keterangan`, `proyek_id`, `login_id`, `waktu_post`) VALUES
(1, '1', '2016-12-14', 1, '1', NULL, 1, '2016-12-14 12:23:34'),
(2, '2', '2016-12-14', 1, '2', NULL, 1, '2016-12-14 12:27:50'),
(4, '3', '2016-12-14', 1, '3', NULL, 1, '2016-12-14 12:48:11');
...
CREATE TABLE IF NOT EXISTS `jurnal_detail` (
  ...
  `anggota_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
INSERT INTO `jurnal_detail` (`id`, `jurnal_id`, `item`, `akun_id`, `debit_kredit`, `nilai`, `anggota_id`) VALUES
(1, 1, 1, 2, 1, 15000, 1),
(2, 1, 2, 1, 0, 15000, 2),
(3, 2, 1, 2, 1, 25000, 1),
(4, 2, 2, 1, 0, 25000, 2),
...
ALTER TABLE `jurnal_detail`
  ADD CONSTRAINT `jurnal_detail_ibfk_3` FOREIGN KEY (`anggota_id`) REFERENCES `anggota` (`id`),
